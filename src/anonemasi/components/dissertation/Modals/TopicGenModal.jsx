        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg glass-panel bg-[#141416] border border-white/10 rounded-3xl p-8 shadow-2xl overflow-hidden"
                >
                    {/* Background Glow */}
                    ...
                    <div className="flex items-center justify-between mb-8">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-2xl font-bold font-outfit text-white">Generate Topics</h2>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:border-indigo-500/50 focus:ring-0 transition-all placeholder:text-white/20"
                            />
                        </div>
