    ...
    return (
        <footer className="p-3 pb-4 border-t border-zinc-200 dark:border-white/5 bg-white dark:bg-[var(--bg-color)] z-10 shrink-0">
            <div className="max-w-4xl mx-auto">
                <div className="relative bg-white dark:bg-white/5 border border-zinc-300 dark:border-white/10 rounded-xl shadow-sm dark:shadow-none focus-within:border-indigo-400 dark:focus-within:border-indigo-500/50 transition-all">
                    <textarea
                        ref={textareaRef}
                        rows={1}
                        value={input}
