 ...
 */
async function saveTransaction({ chargeId, resourceType, resourceId, userId, phone, operator, email, firstName, lastName, amount, items = [], sellerIds = [] }) {
    const docRef = await addDoc(collection(db, 'transactions'), {
        chargeId,
        resourceType: resourceType || 'marketplace',
        resourceId: resourceId || 'cart',
        userId,
        phone,
        operator,
        email,
        ...
        currency: 'MWK',
        status: 'pending',
        items,      // Added for traceability
        sellerIds,  // Added for traceability
