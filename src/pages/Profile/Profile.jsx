...
const Profile = () => {
    ...
    return (
        <div className="pt-32 pb-20 px-4 min-h-screen relative overflow-hidden">
            {/* Background Decor */}
            <div className="absolute top-[10%] left-[-10%] w-[500px] h-[500px] bg-primary/5 rounded-full blur-[120px] -z-10 animate-pulse" />
            <div className="absolute bottom-[20%] right-[-10%] w-[400px] h-[400px] bg-purple-500/5 rounded-full blur-[100px] -z-10" />
            ...
            <div className="max-w-[1000px] mx-auto">
                ...
                <div className="flex items-center justify-between mb-12">
                    ...
                    <motion.button
                        ...
                        onClick={handleSave}
                        disabled={isSaving}
                        className="btn btn-primary px-8 py-4 rounded-2xl flex items-center gap-3 shadow-[0_15px_30px_-10px_rgba(16,185,129,0.3)] disabled:opacity-70"
                    >
                        {isSaving ? <Cpu className="animate-spin" size={18} /> : <Save size={18} />}
                        <span className="font-black uppercase tracking-widest text-xs">{isSaving ? 'Syncing...' : 'Save Changes'}</span>
                    </motion.button>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-8">
                        <motion.div
                            ...
                            className="glass-premium rounded-[48px] border-glass-border p-10 flex flex-col items-center text-center relative overflow-hidden group"
                        >
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div className="bg-white/5 rounded-2xl p-4 border border-glass-border">
                                    ...
                                    <p className="text-xs font-bold text-text-primary">System access synchronized</p>
                                </div>
                                <div className="bg-white/5 rounded-2xl p-4 border border-glass-border opacity-50">
                                    ...
                                    <p className="text-xs font-bold text-text-primary">Founder credentials updated</p>
                                </div>
                            </div>
                        </motion.div>
                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <motion.div
                            ...
                            className="glass-premium rounded-[48px] border-glass-border p-10"
                        >
                            ...
                            <div>
                                <label className="text-[10px] uppercase tracking-[0.2em] text-text-muted font-black mb-2 block ml-1">Founder Biography</label>
                                <textarea
