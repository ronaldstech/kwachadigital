...
const TickerItem = ({ item, isReverse = false }) => {
    ...
    return (
        <div className={`flex items-center gap-5 glass-premium px-8 py-4 rounded-[24px] border border-white/10 transition-all duration-500 hover:border-primary/40 group ${isReverse ? 'opacity-70 hover:opacity-100' : ''}`}>
            <div className={`relative p-3 rounded-xl bg-surface-1 border border-white/5 text-primary group-hover:scale-110 transition-transform`} style={{ color: item.color }}>
                <Icon size={20} />
            </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="inline-flex items-center gap-2 md:gap-3 px-3 md:px-4 py-1.5 md:py-2 glass-premium rounded-full border border-white/10 mb-6 md:mb-8"
                            >
                            ...
                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6 justify-center lg:justify-start">
                                <Link to="/marketplace" className="w-full sm:w-auto">
                                    <MagneticButton>
                                        <div className="bg-primary text-white px-8 md:px-10 py-4 md:py-5 rounded-[18px] md:rounded-[22px] flex items-center justify-center sm:justify-start gap-3 font-black text-base md:text-lg transition-transform active:scale-95 w-full">
                                            Start Exploring
                        ...
                        <div className="flex-1 relative w-full lg:w-auto h-[400px] sm:h-[500px] lg:h-[600px] mt-8 lg:mt-0">
                            ...
                            <div
                                className="absolute -bottom-6 -left-6 md:-bottom-10 md:-left-10 glass-premium p-4 md:p-6 rounded-2xl md:rounded-3xl border border-white/20 hidden md:block"
                            >
